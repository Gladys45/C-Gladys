...
//                   discuss pricing. Via Whatsapp, phone, or email - we’re here to help you find your
//                 </p>
...
//                   >
//                     Schedule Visit Reach Out to us On whatsapp
//                   </button>
//                 </div>
//               </div>
...
export default function PropertyDetailsPage({
  ...
  const overviewFacts = [
    { label: "Property Type", value: formatEnumLabel(property.kind) },
    { label: "Purpose", value: formatEnumLabel(property.purpose) },
    { label: "Market Status", value: isOffMarket ? "OFF MARKET" : formatEnumLabel(property.marketType) },
    {
      label: "Bedrooms",
      value: displayValue(property.house?.bedrooms ?? property.bedrooms),
    },
  ...
  return (
    <>
      <Head>
        <title>{isOffMarket ? `OFF MARKET: ${property.title}` : property.title}</title>
        <meta name="description" content={metaDescription} />
        {isOffMarket && <meta name="robots" content="noindex" />}
      </Head>
      ...
      <main id="top" className="min-h-screen bg-gray-50">
        <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr]">
            <div className="space-y-8">
              {/* Pass isOffMarket to PropertyGallery */}
              <PropertyGallery 
                images={safeImages} 
              ...
              <section className="rounded-3xl border border-gray-200 bg-white p-6 md:p-8">
                <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  ...
                  <div className={`rounded-2xl px-5 py-4 text-white ${
                    isOffMarket ? "bg-gray-600" : "bg-black"
                  }`}>
                    <p className="text-xs uppercase tracking-wide text-gray-300">
                      {isOffMarket ? "Previous Price" : "Price"}
                    </p>
                    <p className={`mt-1 text-2xl font-bold ${
                      isOffMarket ? "line-through" : ""
                    }`}>
                      {formatPrice(
                        property.priceAmount,
                        property.priceCurrency,
            ...
            <aside className="space-y-6">
              <div className={`rounded-3xl border ${
                isOffMarket ? "border-gray-300 bg-gray-50" : "border-gray-200 bg-white"
              } p-6`}>
                <h2 className="text-xl font-semibold text-gray-900">
                  {isOffMarket ? "Property Unavailable" : "Interested in this property?"}
                </h2>
                <p className="mt-3 text-gray-600">
                  {isOffMarket 
                    ? "This property is currently off the market and not available for sale or rent."
                    : "Contact us to request more information, schedule a visit, or discuss pricing. Via Whatsapp, phone, or email - we're here to help you find your"}
                </p>
