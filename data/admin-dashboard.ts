...
export const dashboardTabs: DashboardTab[] = [
  {
    ...
    label: "Properties",
    description:
      "Manage listings, statuses, and publishing workflow.",
    icon: HiHome,
    count: "24",
  },
  {
    ...
    label: "Bookings",
    description:
      "Track requests, approvals, and scheduling activities.",
    icon: HiCalendar,
    count: "18",
  },
  {
    ...
    label: "Contacts",
    description:
      "Review leads, inquiries, and communication pipeline.",
    icon: HiInbox,
    count: "31",
  },
];
...
export const contactKanban: KanbanColumn[] = [
  {
    title: "Unread",
    items: [
      "Interested in apartment pricing",
      "Need full property details",
    ],
  },
  {
    title: "Pending",
  ...
  },
  {
    title: "Replied",
    items: [
      "Need investment consultation",
      "Follow-up sent",
    ],
  },
];

export function getMetricsByTab(
  tab: DashboardTabKey
): MetricItem[] {
  if (tab === "properties") {
    return [
